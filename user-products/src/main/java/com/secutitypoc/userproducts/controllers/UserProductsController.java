...
public class UserProductsController {
    ...
    public ResponseEntity<AddUserProductsResponse> addProductsToUser(@RequestBody Request request){
    ...
    public ResponseEntity<RemoveUserProductsResponse> removeProductsFromUser(@RequestBody RemoveUserProductsRequest request){
